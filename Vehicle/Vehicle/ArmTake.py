...
# got.mechanical_single_joint_control(2,10,500)#控制一个关节的角度
...
i=1
while i<2:
    got.mechanical_single_joint_control(2,120,3000)#控制一个关节的角度
    time.sleep(1)
    i=i+1
...
# time.sleep(1)
got.mechanical_single_joint_control(2,90,4000)#控制一个关节的角度
time.sleep(2.6)
# got.mechanical_arms_restory()
got.mecanum_move_speed_times(1,20,10,1)
